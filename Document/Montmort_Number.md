...
$$M_N=\begin{cases} 0 & (N=1) \\ 1 & (N=2) \\ (N-1)(M\_{N-1}+M\_{N-2}) & (N \geq 3) \end{cases}$$
...
$$M\_N=(N-1)(M\_{N-1}+M\_{N-2})$$

となる.

また, この漸化式を変形すると,

$$M\_N-M\_{N-1}=-(M\_{N-1}-(N-1) M\_{N-2})$$
...
$$M\_N=\begin{cases} 0 & (N=1) \\ NM\_{N-1}+(-1)^N & (N \geq 2) \end{cases}$$
